...
- `node scripts/harness.mjs` provides `new`, `add-app`, `add-data-pack`, `validate-data`, `list`, `doctor`, `export`, `prepare`, `verify-static`, `verify`, and `build`.
...
node scripts/harness.mjs add-data-pack subject-profile-copy ./my-data-pack --id my-synthetic-pack-v1
...
- Reusable v0.7.0 CLI/template foundation.
...
- Phase 3 release candidate preflight, package assembly, screenshot/data validation evidence pack, and GitHub draft release automation.

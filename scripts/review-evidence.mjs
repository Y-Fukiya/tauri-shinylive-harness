...
const defaultEvidenceSources = () => [
  ...
  { id: "phi-pii-scan", label: "PHI/PII synthetic-data guard", category: "security", path: path.join(reportsRoot, "phi-pii-scan.json"), required: true },
  ...
  { id: "offline-verification", label: "Offline content verification", category: "release", path: path.join(reportsRoot, "offline-verification.json"), required: true },
  { id: "release-gate", label: "Release gate result", category: "release", path: path.join(reportsRoot, "release-gate.json"), required: false },
